        ...
        <el-main>
          <el-scrollbar>
            ...
            <el-card class="card">
                <span>金币</span>
                <h2 id="gold">--</h2>
                <a href="/#/store"><el-icon><ArrowRight /></el-icon></a>
            </el-card>
            <el-card class="card">
                <span>银币</span>
                <h2 id="silver">--</h2>
            ...
            <el-card class="card">
                <span>用户ID</span>
                <h2 id="id">--</h2>
                <a href="/#/settings"><el-icon><ArrowRight /></el-icon></a>
            </el-card>
          </el-scrollbar>
        </el-main>
      </el-container>
...
.then(function(Response){
    ...
    if (isPassedVerifictionInt(ResponseCode,200) == true){
        ...
        document.getElementById('welcome').innerHTML = `${userData['username']}`;
        document.getElementById('gold').innerHTML = `${userData['gold']}`;
        document.getElementById('silver').innerHTML = `${userData['silver']}`;
        document.getElementById('id').innerHTML = `${userData['userID']}`;
    }else{
        if (ResponseCode == 423){
